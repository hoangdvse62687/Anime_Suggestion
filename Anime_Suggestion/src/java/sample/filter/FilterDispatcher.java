...
public class FilterDispatcher implements Filter {
     ...
     */
    private final String defaultPage = "home.jsp";
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try{
            ...
            if(resource.lastIndexOf(".html") > 0 || resource.lastIndexOf(".jsp") > 0
                || resource.lastIndexOf(".jpg") > 0 || resource.lastIndexOf(".png") > 0
                    || resource.lastIndexOf(".gif") > 0 || resource.lastIndexOf(".css") > 0
                    || resource.lastIndexOf(".js") > 0 || resource.lastIndexOf(".xml") > 0
                    || resource.lastIndexOf(".xsl") > 0 || resource.lastIndexOf(".xsd") > 0
                    || uri.lastIndexOf("resources") > 0){
                url = resource;
            }
            if(url != null){
